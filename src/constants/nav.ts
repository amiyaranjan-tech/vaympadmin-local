import {
  LayoutDashboard, ShoppingBag, Store, Bike, Package, ClipboardCheck, Image, LayoutGrid, PanelLeft, Tag, Calendar,
...
export const NAV = [
  ...
  { to: "/category-sidebar-banners", label: "Category Sidebar Banners", icon: PanelLeft },
